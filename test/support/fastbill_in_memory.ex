defmodule TimeTracking.Fastbill.InMemory do
  ...
  def find_project(%{external_id: "toggl:toggl_id_found", client_id: "client_1"}) do
    {:ok,
     %{
       id: "project_1",
       external_id: "toggl:toggl_id_found",
       client_id: "client_1",
  ...
  def create_project(%{
        client_id: "client_1",
        external_id: "toggl:toggl_id_not_found",
        name: "New Project"
      }) do
    {:ok,
     %{
  ...
  def create_time_slot(%{
        ...
        date: "2016-05-08T11:17:53+02:00",
        start_time: "2016-05-08T11:17:53+02:00",
        end_time: "2016-05-08T19:39:11+02:00",
