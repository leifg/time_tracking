defmodule TimeTracking.Fastbill.InMemory do
  ...
  def find_client(%{external_id: "toggl_id_found"}) do
    {:ok, %{id: "1", external_id: "toggl_id_found", name: "found before"}}
  end
  ...
  def create_client(%{external_id: "toggl_id_not_found", name: "Shaidy & Co"}) do
    {:ok, %{id: "2", external_id: "toggl_id_not_found", name: "Shaidy & Co"}}
  end

  def find_project(%{external_id: "toggl_id_found", client_id: "client_id"}) do
    {:ok, %{id: "project_1", external_id: "toggl_id_found", client_id: "client_id", name: "Already Existing"}}
  end
